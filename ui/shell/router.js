...
function homeViewClassic(){
 ...
 <div class="disciplineGrid disciplineGrid415">
  ...
  <article class="disciplineTile activeDiscipline"><div class="tileTop"><div class="tileIcon">${uiIcon('car')}</div><span class="badge liveBadge">EFRA 2026</span></div><div><h3>EFRA RC</h3><p>Расстановка (Seeding), практика, Round-by-Round квалификация и финалы A/B/C.</p></div><button class="tileAction" data-classic-action="open"><span>${typeof ClassicRCEngine!=='undefined'&&ClassicRCEngine.hasActive()?'Открыть соревнование':'Создать соревнование'}</span>${uiIcon('chevron')}</button></article>
...
function homeViewRxui(){
 ...
 <div class="heroPanel homeHeroPanel"><div class="heroCopy"><div class="sectionLabel">RACE MANAGEMENT SYSTEM</div><h1>LEGION <span>RX</span></h1><p>RC-соревнования, тренировки и хронометраж LapWiz.</p></div><div class="heroStatus">${live}</div></div>
 <div class="homeSectionHead"><div><div class="sectionLabel">ДИСЦИПЛИНЫ</div><h2>Выберите формат</h2></div></div>
 <div class="disciplineGrid disciplineGrid415">
  ...
  <article class="disciplineTile activeDiscipline"><div class="tileTop"><div class="tileIcon">${uiIcon('car')}</div><span class="badge liveBadge">EFRA 2026</span></div><div><h3>EFRA RC</h3><p>Расстановка (Seeding), практика, квалификация и финалы по правилам EFRA.</p></div><button class="tileAction" data-classic-action="open"><span>${typeof ClassicRCEngine!=='undefined'&&ClassicRCEngine.hasActive()?'Открыть соревнование':'Создать соревнование'}</span>${uiIcon('chevron')}</button></article>
...
function homeView(){return (state.settings.uiSkin||'classic')==='classic'?homeViewClassic():homeViewRxui();}
