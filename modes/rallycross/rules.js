...
function makeRace(input={}){
  ...
  return {
    ...
    pilots:[],heats:[],finals:[],finalProtocol:[],qualificationRunoffOrder:{},finalRunoffOrder:{},runoffCounter:0,stage:'setup',lifecycleStatus:'active',createdAt:now,updatedAt:now,completedAt:'',
    raceSettings:{
