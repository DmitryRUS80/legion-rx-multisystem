...
function runRallyCrossSelfTest(){
 ...
 const lapRule={limitType:'laps',targetLaps:7};
 eq('Lap finish: no early FIN',lapRaceFinishDecision(lapRule,{lapFinishOpen:false},{laps:6}).finishPilot,false);
 eq('Lap finish: leader FIN',lapRaceFinishDecision(lapRule,{lapFinishOpen:false},{laps:7}).finishPilot,true);
