'use strict';
(function(root){
  const appVersion='4.2.0-clean-full-rc57-session-control';
  const displayVersion='4.2.0 CLEAN FULL APP RC57 · SESSION CONTROL';
  const cacheName='legion-rx-4-2-0-clean-full-rc57-session-control';
  const assets=[
    './',
