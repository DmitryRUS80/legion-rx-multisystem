'use strict';
(function(root){
  const appVersion='4.2.0-clean-full-rc42-apex-alternate-renderer';
  const displayVersion='4.2.0 CLEAN FULL APP RC42 · APEX ALTERNATE RENDERER TEST';
  const cacheName='legion-rx-4-2-0-clean-full-rc42-apex-alternate-renderer';
  const assets=[
    './',
    ...
    './ui/fonts/oswald.css','./ui/themes/theme.css','./ui/shell/app.css','./ui/pilots/pilot-cards.css','./ui/shell/discipline-pults.css','./ui/shell/runtime-error.js','./ui/shell/discipline-shared.js','./ui/pilots/pilot-cards.js','./ui/shell/views.js','./ui/shell/router.js','./ui/shell/actions.js','./ui/shell/offline-runtime.js','./ui/discipline-ui.js','./ui/skins/apex/apex.css','./ui/skins/apex/apex-renderer.js',
