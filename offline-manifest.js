'use strict';
(function(root){
  const appVersion='4.2.0-clean-full-rc72-schedule-protocol-ux';
  const displayVersion='4.2.0 CLEAN FULL APP RC72 · SCHEDULE + PROTOCOL UX';
  const cacheName='legion-rx-4-2-0-clean-full-rc72-schedule-protocol-ux';
  const assets=[
    './',
