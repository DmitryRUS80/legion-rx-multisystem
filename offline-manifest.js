'use strict';
(function(root){
  const appVersion='4.2.0-clean-full-rc41-apex-orange-skin';
  const displayVersion='4.2.0 CLEAN FULL APP RC41 · APEX ORANGE SKIN';
  const cacheName='legion-rx-4-2-0-clean-full-rc41-apex-orange-skin';
  const assets=[
    './',
    ...
    './ui/fonts/oswald.css','./ui/themes/theme.css','./ui/shell/app.css','./ui/pilots/pilot-cards.css','./ui/shell/discipline-pults.css','./ui/skins/apex-orange.css','./ui/shell/runtime-error.js','./ui/shell/discipline-shared.js','./ui/pilots/pilot-cards.js','./ui/shell/views.js','./ui/shell/router.js','./ui/shell/actions.js','./ui/shell/offline-runtime.js','./ui/discipline-ui.js',
