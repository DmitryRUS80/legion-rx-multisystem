'use strict';
(function(root){
  const appVersion='4.2.0-clean-full-rc21-ios-start-safety';
  const displayVersion='4.2.0 CLEAN FULL APP RC21 · IOS START SAFETY';
  const cacheName='legion-rx-4-2-0-clean-full-rc21-ios-start-safety';
  const assets=[
    './',
    ...
    './ui/fonts/oswald.css','./ui/themes/theme.css','./ui/shell/app.css','./ui/shell/discipline-pults.css','./ui/shell/runtime-error.js','./ui/shell/discipline-shared.js','./ui/shell/views.js','./ui/shell/router.js','./ui/shell/actions.js','./ui/shell/offline-runtime.js','./ui/discipline-ui.js',
