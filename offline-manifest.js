'use strict';
(function(root){
  const appVersion='4.2.0-clean-full-rc50-phone-landscape-geometry';
  const displayVersion='4.2.0 CLEAN FULL APP RC50 · PHONE LANDSCAPE GEOMETRY';
  const cacheName='legion-rx-4-2-0-clean-full-rc50-phone-landscape-geometry';
  const assets=[
    './',
    ...
    './ui/fonts/oswald.css','./ui/themes/theme.css','./ui/shell/app.css','./ui/pilots/pilot-cards.css','./ui/shell/discipline-pults.css','./ui/skins/rxui/base.css','./ui/skins/rxui/steel.css','./ui/skins/rxui/cobalt.css','./ui/skins/rxui/light.css','./ui/skins/rxui/modern.css','./ui/skins/rxui/heritage.css','./ui/skins/rxui/icons.js','./ui/classic-polish/classic-controls.css','./ui/classic-polish/classic-icons.js','./ui/shell/runtime-error.js','./ui/shell/discipline-shared.js','./ui/pilots/pilot-cards.js','./ui/shell/views.js','./ui/shell/router.js','./ui/shell/actions.js','./ui/shell/offline-runtime.js','./ui/discipline-ui.js',
