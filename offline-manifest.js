'use strict';
(function(root){
  const appVersion='4.2.0-clean-full-rc20-clean-foundation';
  const displayVersion='4.2.0 CLEAN FULL APP RC20 · CLEAN FOUNDATION';
  const cacheName='legion-rx-4-2-0-clean-full-rc20-clean-foundation';
  const assets=[
    './',
