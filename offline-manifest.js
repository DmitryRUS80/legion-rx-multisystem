'use strict';
(function(root){
  const appVersion='4.2.0-clean-full-rc67-classic-schedule-portal-hit-fix';
  const displayVersion='4.2.0 CLEAN FULL APP RC67 · CLASSIC SCHEDULE PORTAL HIT FIX';
  const cacheName='legion-rx-4-2-0-clean-full-rc67-classic-schedule-portal-hit-fix';
  const assets=[
    './',
