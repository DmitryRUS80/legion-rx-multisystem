...
assert 'rc50-phone-landscape-geometry' in om
assert 'RC50 · PHONE LANDSCAPE GEOMETRY' in ver
assert "importScripts('./offline-manifest.js?build=rc50-phone-landscape-geometry')" in sw
...
assert 'repeat(6,minmax(0,1fr))' in base
