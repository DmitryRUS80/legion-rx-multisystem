...
checks['compact_picker_cards']='pilotPickerModelChipMarkup' in pilot and 'data-picker-profile' in pilot and 'repeat(auto-fill,minmax(175px,1fr))' in css
...
checks['rc25_css_authoritative']=css.startswith('/* LEGION RX · PILOT CARDS · authoritative component styles · RC25')
