...
checks={
 ...
 'portrait_stays_inside_roster': '@media (orientation:portrait)' in css and 'max-width:calc(100% - 8px)' in css and 'height:calc(100% - 8px)' in css,
 ...
 'worst_only_text_accent': ('.rxnPilotStatsLap.worst strong,.rxnPilotStatsLap.worst em{color:var(--rxn-magenta)}' in css or '.rxnPilotStatsLap.worst strong,.rxnPilotStatsLap.worst em{color:var(--rxn-red)}' in css) and '.rxnPilotStatsLap.worst{' not in css,
