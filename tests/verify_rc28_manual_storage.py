...
# RC29 intentionally changes RallyCross scoring/tie logic; BLE and unrelated sport/reporting remain byte-identical to RC28.
expected={
...
checks['unrelated_ble_reporting_unchanged']=not changed
