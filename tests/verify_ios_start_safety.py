...
checks['new_cache_namespace']='rc32-skip-flow-state-safety' in cfg
...
# RC32 changes only RallyCross administrative state handling over RC31. Unrelated modes and platform audio remain byte-identical.
