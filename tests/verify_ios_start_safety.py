...
checks['new_cache_namespace']='rc29-rallycross-runoff-tiebreak' in cfg
...
# RC29 intentionally changes RallyCross sport rules. Unrelated sport modes and RallyCross audio actions must remain byte-identical.
...
checks['unrelated_sport_and_audio_actions_unchanged']=not changed
